...
\begin{figure}[htp]
    \centering
    \includegraphics[width=13cm]{rviz_force1.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=13cm]{rviz_force2.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=13cm]{rviz_force3.png}
...
\begin{figure}[htp]
    \centering
    \includegraphics[width=13cm]{rviz_force5.png}
